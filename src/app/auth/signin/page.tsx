    ...
    <div className="min-h-screen flex items-center justify-center bg-surface py-12 px-4">
      <div className="max-w-md w-full space-y-6 bg-white rounded-card shadow-soft border border-brand-200 p-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl text-brand-950">Welcome back</h2>
          <p className="mt-2 text-brand-500 text-sm">Sign in to your Align Bookstore account</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-3 bg-white text-brand-400">Or sign in with email</span>
          </div>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-brand-950 mb-1.5">Email</label>
          ...
          <div>
            <label className="block text-sm font-medium text-brand-950 mb-1.5">Password</label>
