      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-8 h-8 bg-amber-400 rounded-lg flex items-center justify-center flex-shrink-0">
                <span className="text-brand-950 text-sm font-bold">A</span>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={label}>
                  <Link href={href} className="hover:text-brand-700 transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/shipping-policy" className="hover:text-brand-700 transition-colors">
                  Shipping Policy
                </Link>
              </li>
              {["FAQ", "Returns", "Contact Us"].map((l) => (
                <li key={l}>
                  <span className="cursor-default hover:text-white transition-colors">{l}</span>
                </li>
              ))}
              <li>
                <a href="mailto:hello@alignbookstore.com" className="hover:text-brand-700 transition-colors">
                  hello@alignbookstore.com
                </a>
              </li>
            </ul>
          </div>
