    ...
    <aside className="w-64 min-h-screen bg-brand-950 flex flex-col flex-shrink-0">
      ...
      <div className="px-6 py-5 border-b border-white/10">
        <Link href="/admin" className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-white text-sm font-semibold leading-tight">Align Bookstore</p>
      ...
      <div className="px-3 py-4 border-t border-white/10 space-y-1">
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-brand-400 hover:text-white hover:bg-white/5 transition-colors"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
